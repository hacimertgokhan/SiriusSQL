            ...
            if command == '$db-list':
                ...
                if enterDB_MYSQLDBCommand == '$list-table':
                    ...
                    if valueCount == '1':
                        ...
                        print(
                            "MYSQL / " + databaseName + " | Example: INSERT INTO " + value + " (>>:TARGET:name<<) VALUES (Jhon)")
                        mxr_value = input("MYSQL / " + databaseName + " | Please enter a target. ")
                        print(
                            "MYSQL / " + databaseName + " | Example: INSERT INTO " + value + " (>>:TARGET:name<<) VALUES (>>:TARGET_VALUE:Jhon<<)")
...
def insertInto(val1, val2, val3):
    sql = "INSERT INTO " + val1 + " (" + val2 + ") VALUES (" + val3 + ")"
    cursor.execute(sql)
